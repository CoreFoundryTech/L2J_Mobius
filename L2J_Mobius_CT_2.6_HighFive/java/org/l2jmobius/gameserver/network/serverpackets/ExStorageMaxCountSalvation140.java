...
/**
 * Salvation 140 storage limits packet shape.
 */
public class ExStorageMaxCountSalvation140 implements IClientOutgoingPacket
{
	...
	public ExStorageMaxCountSalvation140(PlayerInstance player)
	{
	...
	{
		OutgoingPackets.EX_STORAGE_MAX_COUNT.writeId(packet); // Salvation 5.0 keeps 0xFE:0x2F.
		...
		packet.writeD(40); // Salvation reference placeholder.
		packet.writeD(40); // Salvation reference placeholder.
		return true;
	}
}
