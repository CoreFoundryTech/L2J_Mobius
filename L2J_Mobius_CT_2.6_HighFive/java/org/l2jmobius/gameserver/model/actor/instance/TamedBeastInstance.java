...
public class TamedBeastInstance extends FeedableBeastInstance
{
	...
	public TamedBeastInstance(int npcTemplateId, PlayerInstance owner, int foodSkillId, int x, int y, int z)
	{
		super(NpcData.getInstance().getTemplate(npcTemplateId));
		_isFreyaBeast = false;
		setInstanceType(InstanceType.TamedBeastInstance);
	...
	public TamedBeastInstance(int npcTemplateId, PlayerInstance owner, int food, int x, int y, int z, boolean isFreyaBeast)
	{
		super(NpcData.getInstance().getTemplate(npcTemplateId));
